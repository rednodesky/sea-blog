...
import com.sea.shiroRedis.exception.PrincipalInstanceException;
import com.sea.shiroRedis.exception.SerializationException;
import com.sea.shiroRedis.serializer.ObjectSerializer;
import com.sea.shiroRedis.serializer.RedisSerializer;
import com.sea.shiroRedis.serializer.StringSerializer;
...
//		List<User> users =key.asList();
//		redisKey = users.get(0).getLoginName();
